...
//	Fighter ability to distinguish among weapons and armors
...
int cmd_compare(string str) {
	...
	notify_fail("You do not know enough about weapons and armors.\n");
	return 0;
    }
...
void help() {
	...
	"qualities of weapons and armor.  This ability will say nothing\n"+
