...
int cmd_drain(string str)
  ...
  if((string)this_player()->query_class()!="kataan")
   {
    /* This used to punish the caster with real damage and stat
       penalties just for typing "drain" with no target - a live
       damage trap, not a real class gate. Denying like every other
       class-gated file here instead (2026-07-29). */
    notify_fail("The demons of the underworld ignore you.\n");
    return 0;
   }
