...
private void define_quests() {
    ...
    __quests["cold_storage_escapee"] = ([
        "name"           : "What Got Out",
        "giver"          : "kennel master",
        "start_location" : "The kennel master at Lone Star's kennel yard.",
        "desc"           : "Two cradles in Lone Star's cold storage came up empty. A failed "
                           "specimen woke up and walked out under its own power. It is still "
                           "down there. Find it in cold storage and put it down.",
        "objectives"     : ([ "specimen_destroyed" : 1 ]),
        "reward_xp"      : 900,
        "reward_credits" : 400,
        "reward_infamy"  : 0
    ]);
    __quests["preserve_beast_hide"] = ([
        "name"           : "A Buyer for Hides",
        "giver"          : "vendor",
        "start_location" : "The black market vendor in Splynn's hidden chamber.",
        "desc"           : "The black market vendor deals in exotic goods and wants a preserve "
                           "beast hide. Hunt a preserve beast in the Splynn Preserves and bring "
                           "the hide back.",
        "objectives"     : ([ "alien_hide_delivered" : 1 ]),
        "reward_xp"      : 800,
        "reward_credits" : 500,
        "reward_infamy"  : 0
    ]);
    __quests["silence_the_scout"] = ([
        "name"           : "Mark the Marker",
        "giver"          : "militia",
        "start_location" : "Tolkeen militia, patrolling the walls.",
        "desc"           : "A CS siege scout has been spotted marking Tolkeen's walls for the "
                           "next push. Find it on the siege edge and put it down before it "
                           "reports back.",
        "objectives"     : ([ "scout_silenced" : 1 ]),
        "reward_xp"      : 1200,
        "reward_credits" : 300,
        "reward_infamy"  : 0
    ]);
    __quests["quarry_lurker_cull"] = ([
        "name"           : "Something in the Quarry",
        "giver"          : "hermit",
        "start_location" : "The hermit near the Horton quarry rim.",
        "desc"           : "The lurker nesting in the old quarry has taken scrap, and it has "
                           "taken people. The hermit wants it dealt with.",
        "objectives"     : ([ "lurker_defeated" : 1 ]),
        "reward_xp"      : 850,
        "reward_credits" : 250,
        "reward_infamy"  : 0
    ]);
    __quests["border_gargoyle_raider"] = ([
        "name"           : "Raider on the Wire",
        "giver"          : "border guard",
        "start_location" : "The NGR border guard at the checkpoint.",
        "desc"           : "A gargoyle raider has been crossing no man's land near the "
                           "checkpoint. The border guard wants it eliminated before it brings "
                           "the rest of its raiding caste.",
        "objectives"     : ([ "raider_eliminated" : 1 ]),
        "reward_xp"      : 1800,
        "reward_credits" : 700,
        "reward_infamy"  : 0
    ]);
    __quests["lazlo_shore_dog"] = ([
        "name"           : "Trouble on the Shore",
        "giver"          : "gate guard",
        "start_location" : "The Lazlo gate guard.",
        "desc"           : "A feral dog working the lake shore has been snapping at traders. "
                           "The gate guard wants it driven off before someone gets bitten.",
        "objectives"     : ([ "dog_driven_off" : 1 ]),
        "reward_xp"      : 500,
        "reward_credits" : 250,
        "reward_infamy"  : 0
    ]);
    __quests["harbor_watch"] = ([
        "name"           : "Watching the Water",
        "giver"          : "elena",
        "start_location" : "Elena Vasquez, in La Cantina.",
        "desc"           : "Wild vampires sometimes follow the cargo boats into Puerto Angel "
                           "harbor at night. Elena wants someone to scout the harbor and report "
                           "back what they find.",
        "objectives"     : ([ "harbor_scouted" : 1 ]),
        "reward_xp"      : 700,
        "reward_credits" : 300,
        "reward_infamy"  : 0
    ]);
