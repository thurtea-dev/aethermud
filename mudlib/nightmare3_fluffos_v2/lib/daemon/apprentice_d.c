...
void ensure_dirs() {
    if((int)unguarded((: file_size, SAVE_DIR :)) != -2)
        unguarded((: mkdir, SAVE_DIR :));
    if((int)unguarded((: file_size, SUB_DIR :)) != -2)
        unguarded((: mkdir, SUB_DIR :));
    if((int)unguarded((: file_size, PLAY_DIR :)) != -2)
        unguarded((: mkdir, PLAY_DIR :));
}
