// /daemon/tattoo_d.c
// AetherMUD  -  Atlantean Tattoo Magic system daemon.
...
// Returns every valid body location, for callers that need to parse
// free-form "<location> <tattoo name>" input against the known set
// (see tattoo_gun.c's cmd_tattoo_direct()).
string *query_all_locations() { return all_locations(); }
