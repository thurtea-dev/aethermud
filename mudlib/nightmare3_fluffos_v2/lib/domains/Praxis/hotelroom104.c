/* /d/Praxis/hotelroom104.c
   Praxis Refuge Inn guest room 104 (regular).
   Rented through the receptionist in hotel.c; door key checked by hall2.c. */
...
void create() {
    ...
    set_short("Praxis Refuge Inn, Room 104");
    set_long(
    ...
    set_exits( ([ "out" : "/domains/Praxis/hall2" ]) );
}
