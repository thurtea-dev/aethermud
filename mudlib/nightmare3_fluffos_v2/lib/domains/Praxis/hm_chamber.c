...
set_long( "You have entered the forum for the High Mortals of "
"Rifts Earth. You see a large round table standing in the middle "
"of the room, surrounded by oaken chairs. %^BLUE%^Blue%^RESET%^ carpet "
"is on the floor, and the walls have been painted a cream color. "
);
set_items( ([
"table" : "A large, round oaken table.",
"chairs" : "The chairs match the wood of the table.",
"carpet" : "The carpet is a deep blue.",
"walls" : "The walls are cream colored."
]) );
