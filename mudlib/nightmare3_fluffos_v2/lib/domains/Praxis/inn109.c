// /d/Praxis/inn109.c
// Survivors' Hostel, Private Room 3. Third room off the rental hallway.
...
void create() {
    ...
    set_long(
        ...
        "The rental hall continues south, and north to the last door.");
    set_exits( ([
        "south" : "/domains/Praxis/inn108",
        "north" : "/domains/Praxis/inn110"
    ]) );
    set_items( ([
