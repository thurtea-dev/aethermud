...
void create() {
  ::create();
    ...
    set_short( "the north end of East Road");
    set("long",
   ...
   set_items(
    ...
    set_exits(
	      (["east" : "/domains/Orlith/woodland",
"north" : "/domains/Newbie/main/room/main1",
...
int read(string str) {
  if(str == "sign") {
    write("The sign reads: %^RED%^Welcome all newcomers to Praxis! "
