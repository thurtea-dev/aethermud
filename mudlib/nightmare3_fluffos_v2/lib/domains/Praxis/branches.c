...
void create() {
   ::create();
   set_short("between the branches");
   set_long(
...
"stands near each corner of the platform. ");
   set_properties( (["light" : 2,
                     "indoors" : 1 ,
                     "no castle" : 1]) );
   set_exits( (["down" : "/domains/Praxis/trunk"]) );
   set_items( ([
...
"church" : "The local church is where the class of clerics make "+
                  ...
                  "healers of Praxis have established a hospital just "+
...
"monastery" : "Home of the powerful class of monks, the monastery is a "+
                  ...
                  "of Praxis take place. It is in the main hall of the "+
...
"shop" : "Horace, one of the first true-blooded elves to come to "+
                  "Praxis, promptly set up shop near the east end of "+
                  ...
                  "sell their gear, the High Mortals of Praxis "+
