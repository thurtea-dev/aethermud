...
#define MAGIC_EQ  "/domains/Praxis/equipment/magic_items/"
...
void create() {
    ...
    __items = ([
        ...
        "healing charm" : ({ MAGIC_EQ+"healing_charm.c", 12000, "jade healing charm" }),
        "charm" : ({ MAGIC_EQ+"healing_charm.c", 12000, "jade healing charm" }),
        "jade charm" : ({ MAGIC_EQ+"healing_charm.c", 12000, "jade healing charm" }),
        "rune dagger" : ({ MAGIC_EQ+"rune_dagger.c", 45000, "black rune dagger" }),
        "rune blade" : ({ MAGIC_EQ+"rune_dagger.c", 45000, "black rune dagger" })
    ]);
}
