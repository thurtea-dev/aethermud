...
void create() {
    ...
    set_long(
        ...
        "The main game trail is back south, downhill. The switchback keeps\n"
        "climbing north toward a ledge near the top.");
    set_exits( ([
        "south" : "/domains/Praxis/areas/splynn/preserve_trail",
        "north" : "/domains/Praxis/areas/splynn/preserve_nest"
    ]) );
    set_listen("default",
