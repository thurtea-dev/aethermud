...
void create() {
    ...
    set_long(
        ...
        "give ground easily. The way out is back west, toward the outer\n"
        "spur. The passage also continues down, deeper still, toward a\n"
        "heavier, slower pulse.");
    set_exits( ([
        "west" : "/domains/Praxis/areas/splynn/preserve_hive",
        "down" : "/domains/Praxis/areas/splynn/preserve_hivecore"
    ]) );
    set_listen("default",
