...
void create() {
    ...
    set_long(
        ...
        "The reeds thin out and give way to deeper water east. The rest of\n"
        "the hunting ground lies back west, through the last stand of\n"
        "reeds.");
    set_exits( ([
        "west" : "/domains/Praxis/areas/splynn/preserve_waterhole",
        "east" : "/domains/Praxis/areas/splynn/preserve_sunken"
    ]) );
    set_listen("default",
