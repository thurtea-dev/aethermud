...
void create() {
    ...
    set_long(
        ...
        "runs east toward the forest's ragged edge. A narrow spine of\n"
        "exposed rock leads north, toward a second high place.");
    set_exits( ([
        "south" : "/domains/Praxis/areas/splynn/preserve_snag",
        "east"  : "/domains/Praxis/areas/splynn/preserve_snareline",
        "north" : "/domains/Praxis/areas/splynn/preserve_saddle"
    ]) );
    set_listen("default",
