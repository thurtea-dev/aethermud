...
void create() {
    ...
    set_long(
        ...
        "way back down is south along the catwalk. A knotted rope also\n"
        "drops from the planking into a hollow below, between two of the\n"
        "bone-white trees.");
    set_exits( ([
        "south" : "/domains/Praxis/areas/splynn/preserve_blind",
        "down"  : "/domains/Praxis/areas/splynn/preserve_nook"
    ]) );
    set_listen("default",
