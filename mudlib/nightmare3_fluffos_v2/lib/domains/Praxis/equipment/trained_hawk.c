...
void create() {
    ...
    set_long(
        ...
        "hawk perch, stable hawk. Say commands: say hawk fly, say hawk stay,\n"
        "say hawk come, say hawk attack, say hawk hunt, say hawk perch,\n"
        "say hawk scout.\n\n"
        "Stabling puts the hawk safely away until you call it back with\n"
        "'call hawk' -- useful when you don't want it following you\n"
        "everywhere."
    );
    set_mass(400);
    set_level(4);
