/* /d/Praxis/hotelroom107.c
   Praxis Refuge Inn guest room 107 (deluxe).
   Rented through the receptionist in hotel.c; door key checked by hall4.c. */
...
void create() {
    ...
    set_short("Praxis Refuge Inn, Room 107");
    set_long(
    ...
    set_exits( ([ "out" : "/domains/Praxis/hall4" ]) );
}
