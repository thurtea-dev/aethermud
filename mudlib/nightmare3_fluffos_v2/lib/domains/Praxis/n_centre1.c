...
void create() {
	...
	"church is off to the west. It is a medium sized building, "
	     "made out of sturdy wood that has been painted white. "
	     "A very simple, yet beautiful stain glass window stares "
"out at you from the front of the church. The doors are a deep black, "
"and one is slightly open, in welcome.");
    set_exits(
