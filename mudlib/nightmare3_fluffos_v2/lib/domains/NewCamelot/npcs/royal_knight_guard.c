...
void create() {
    ...
    add_response("hello", "Royal Knight says: 'Hail, traveler. Welcome to New Camelot.'");
    add_response("hi", "Royal Knight says: 'Hail, traveler. Welcome to New Camelot.'");
    add_response("bye", "Royal Knight says: 'Travel safely.'");
    set_default_response("Royal Knight says: 'State your business, or move along.'");
}
