// /domains/DemonPlane/areas/demon_sliver_fissure.c
...
void create() {
    ...
    set_exits( ([
        "south" : "/domains/DemonPlane/areas/demon_sliver_wastes",
        "down" : "/domains/DemonPlane/areas/demon_sliver_pit",
        "east" : "/domains/DemonPlane/areas/demon_sliver_nest"
    ]) );
}
...
void reset() {
    ...
    if(!present("demon sliver stalker", this_object()))
        new("/domains/DemonPlane/monsters/demon_sliver_stalker")->move(this_object());
}
