// /domains/DemonPlane/areas/demon_sliver_wastes.c
...
void create() {
    ...
    set_exits( ([
        "south" : "/domains/DemonPlane/areas/demon_sliver_gate",
        "north" : "/domains/DemonPlane/areas/demon_sliver_fissure",
        "west" : "/domains/DemonPlane/areas/demon_sliver_corridor"
    ]) );
}
...
void reset() {
    ...
    if(!present("demon sliver hunter", this_object()))
        new("/domains/DemonPlane/monsters/demon_sliver_hunter")->move(this_object());
}
