// /domains/DemonPlane/areas/demon_sliver_corridor.c
...
void create() {
    ...
    set_exits( ([
        "east" : "/domains/DemonPlane/areas/demon_sliver_wastes",
        "north" : "/domains/DemonPlane/areas/demon_sliver_shrine",
        "west" : "/domains/DemonPlane/areas/demon_sliver_depths"
    ]) );
}
