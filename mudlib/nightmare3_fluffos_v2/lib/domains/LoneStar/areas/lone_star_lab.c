...
void create() {
    ...
    set_long(
        ...
        "The floor is clean to an almost unsettling degree.  A reinforced corridor\n"
        "leads north to containment, and a cold-sealed door east opens on the\n"
        "gene vault.");
    set_exits( ([
        "south" : "/domains/LoneStar/areas/lone_star_plaza",
        "north" : "/domains/LoneStar/areas/lone_star_containment",
        "east"  : "/domains/LoneStar/areas/lone_star_gene_vault"
    ]) );
    set_listen("default",
    ...
    set_items( ([
        ...
        "partitions" : "Glass dividers between work areas.  Heavy, sealed.",
        "door"       : "A reinforced lab door with a keypad lock."
    ]) );
}
