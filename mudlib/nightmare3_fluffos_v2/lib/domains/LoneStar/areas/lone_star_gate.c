...
void create() {
    ...
    set_long(
        ...
        "The support town sits just south of the checkpoint, outside the wire.\n"
        "Northwest, a drainage wash cuts across the open scrub, below the line\n"
        "of sight from the towers.");
    set_exits( ([
        ...
        "south"     : "/domains/LoneStar/areas/lone_star_support_row",
        "northwest" : "/domains/LoneStar/areas/lone_star_culvert_mouth"
    ]) );
    set_listen("default",
