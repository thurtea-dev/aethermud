...
void create() {
    ...
    set_long(
        ...
        "A smaller door to the north leads to the NCO bunkroom.  A wider door\n"
        "east opens onto the kennel yard.");
    set_exits( ([
        "west"  : "/domains/LoneStar/areas/lone_star_plaza",
        "north" : "/domains/LoneStar/areas/lone_star_bunkroom",
        "east"  : "/domains/LoneStar/areas/lone_star_kennel_yard"
    ]) );
    set_listen("default",
