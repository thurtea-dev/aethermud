...
void create() {
    ...
    set_long(
        ...
        "North, a section of maintenance grating hangs bent outward from a\n"
        "drainage tunnel under the fence line, forced from the inside.\n"
        "Southwest, the motor pool's roll-up door stands open on the road.");
    set_exits( ([
        "south"     : "/domains/LoneStar/areas/lone_star_gate",
        "west"      : "/domains/LoneStar/areas/lone_star_containment",
        "north"     : "/domains/LoneStar/areas/lone_star_escape_tunnel",
        "southwest" : "/domains/LoneStar/areas/lone_star_motorpool"
    ]) );
    set_listen("default",
