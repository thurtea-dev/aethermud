...
void create() {
    ...
    set_long(
        "A comfortable common area reserved for the wizard staff of AetherMUD.\n"
...
void reset() {
    object ob;
    ::reset();
    if(!present("staff bulletin board", this_object())) {
        ob = clone_object("/domains/adm/wiz_tools/staff_board");
