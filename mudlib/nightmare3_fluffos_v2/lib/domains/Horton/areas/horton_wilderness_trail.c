...
void create() {
    ...
    set_long(
        ...
        "regularly. Creek crossing west. Scrub ridge east. Farmstead north.");
    set_exits( ([
        "south" : "/domains/Horton/areas/horton_outskirts",
        "north" : "/domains/Horton/areas/horton_abandoned_farmstead",
        "west"  : "/domains/Horton/areas/horton_creek_crossing",
        "east"  : "/domains/Horton/areas/horton_scrub_ridge"
    ]) );
    set_listen("default",
