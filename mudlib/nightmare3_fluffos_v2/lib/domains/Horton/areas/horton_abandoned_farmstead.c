...
void create() {
    ...
    set_long(
        ...
        "Trail south. Pine hollow north. Cornfield east. Wrecked convoy west.");
    set_exits( ([
        "south" : "/domains/Horton/areas/horton_wilderness_trail",
        "north" : "/domains/Horton/areas/horton_pine_hollow",
        "east"  : "/domains/Horton/areas/horton_cornfield_ruins",
        "west"  : "/domains/Horton/areas/horton_wrecked_convoy"
    ]) );
    set_listen("default",
