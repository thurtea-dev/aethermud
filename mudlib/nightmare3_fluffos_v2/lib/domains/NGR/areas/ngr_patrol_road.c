...
void reset() {
    ...
    /* Gargoyle territory begins past the treeline per the room's own long
       description - an incursion here is foreshadowed, not new lore. */
    if(random(3) == 0 && !present("gargoyle raider", this_object()))
