...
void create() {
    ...
    set_long(
        ...
        "grows. Things hunt here at all hours. The trench is west. The\n"
        "ridge itself rises east, close enough now to make out individual\n"
        "shapes perched along it.");
    set_exits( ([
        "west" : "/domains/NGR/areas/ngr_frontline_trench",
        "east" : "/domains/NGR/areas/ngr_gargoyle_ridge"
    ]) );
    set_listen("default",
