...
private nosave int __ReceivedMudlist, __ServerPort; 
private nosave string __ServerAddr; 
private nosave mapping __Network; 
 
int mud_exists(string mud);
protected void manage_muds();
private nosave void restore_network();
private nosave void save_network();
