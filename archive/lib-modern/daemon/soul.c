...
private nosave string __Adj, __Chunk;
private nosave object __CurrentTarget;

private nosave void become_emotional(mapping info, string adj, object *who);
private nosave void compile_soul(string str);
private nosave string compile_message(mixed *parts, object *targets);
private nosave string remove_whitespace(string str);
protected string filter_stuff(mixed *parts, object *targets);
private nosave void save_soul();
private nosave void restore_soul();
protected string handle_names(object ob);
private nosave void compile_file(string str);
private nosave void parse_assoc(mapping borg);
private nosave mixed parse_chunk();
private nosave mapping parse_mapping();
private nosave string *parse_array();
...
private nosave void compile_file(string file) { 
    string *cles; 
