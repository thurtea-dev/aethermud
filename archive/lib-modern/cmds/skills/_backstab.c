...
//since have element of surprise
     message("other_combat",XX+capitalize(knifname)+" barely misses you.",
              victim);
     message("my_combat", XX+"You miss "+ vicname+" by inches.",
             this_player());
     tell_room(here,bsname+" barely misses "+vicname+".",
               ({victim,this_player()}) );
   }
   else {
     message("other_combat",XX+capitalize(knifname)+" tears into you!",
             victim);
     message("my_combat",XX+"You slash into "+vicname+" with "+
             knifname+"!",this_player());
     tell_room(here,bsname+" slashes "+vicname+" with "+knifname+
               "!",({this_player(),victim}) );
