...
private nosave int __CWDCount, __CWDBottom, __CWDTop, __CmdNumber; 
private nosave int __HistoryCount, __HistoryBottom, __HistoryTop, __HistorySize; 
private nosave string __Prompt; 
private nosave string *__Stack, *__History; 
...
nomask protected int cmd_pwd(string str) {
...
nomask protected private string do_history(string str) { 
    string *args;
    string tmp, cmd, expr;
    int x, slen, i; 
...
nomask protected private void add_history_cmd(string str) { 
