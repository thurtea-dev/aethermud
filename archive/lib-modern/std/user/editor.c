...
private nosave int __Time;
private nosave string __FileName;
private nosave function __Callback, __Abort;
private nosave mixed __Arguments;
...
varargs int edit(string nom, function f, function abort, mixed args) {
    ...
    message("system", "RiftsMUD System Editor", this_object());
