...
private nosave string __Short, __Long, __File;
private nosave mapping __Actions, __Items, __Smells, __Listens, __Objects;
private nosave void main_menu();
protected void primary_prompt();
private nosave string describe_long();
...
private nosave void main_menu() {
    message("info", "\n%^INITTERM%^The RiftsMUD Room Creator "
