...
private nosave string *__Id, *__Adjectives;
private nosave int __Destroy;
nosave string __TrueName, __Creator;
private nosave object __LastLocation;
private nosave mapping __Properties;
private nosave function *__InvisTests;
