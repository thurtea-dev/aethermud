...
nomask protected void check_password(string pass) {
    string password;
...
nomask protected void new_password(string pass) {
    if(strlen(pass) < 5) {
...
nomask protected void confirm_password(string pass2, string pass1) {
    if(pass1 != pass2) {
