...
private nosave string __PlayerName;
private nosave object __NewPlayer;
private nosave mapping __Groups, __ReadAccess, __WriteAccess;
...
private void load_access(string cfg, mapping access_map) {
    string *lines;
    string file, fl, ac;
    int i, maxi;
