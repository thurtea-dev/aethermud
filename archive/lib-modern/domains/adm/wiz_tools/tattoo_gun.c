...
private nosave object selected_player;
private nosave string *loc_list;     // locations of current tattoos (for remove)
private nosave string pending_tattoo; // tattoo name during grant flow
