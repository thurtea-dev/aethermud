...
void create() {
  ::create();
    ...
    set_short( "An orc soldier's chamber");
    set_long(
    ...
    set_exits( (["west" : "/domains/Praxis/orc_valley/passage1"]) );
}
...
void reset() {
  ...
  if(!present("orc")) {
            ...
            ob->set_short( "Orc soldier");
            ob->set_long( "He is ugly and very unhappy about "
		    "your presence.");
