// /domains/NewCamelot/equipment/chain_mail.c
// Chain mail SDC armor, AR 12, SDC 60.
...
void create() {
    ...
    set_long(
        "Interlocked steel rings forming a full haubergeon. Heavy but effective\n"
        "against bladed weapons. Not MDC-rated.\n"
        "Armor Rating: 12. SDC: 60.");
    set_mass(2000);
    set_value(600);
