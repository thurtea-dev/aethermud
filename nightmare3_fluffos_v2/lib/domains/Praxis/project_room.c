...
void create() {
    ...
    set_short("Project Room");
    set_long("Welcome to the Project Tracking Department!\n"
      "A list of commands is printed on the wall, use <read list> to view it. "
      "This is the room you can come to find out about "
      "what is going on on the immortal plane of AetherMUD.");
    set_exits( ([ "west" : "/domains/Praxis/mudlib" ]) );
}
