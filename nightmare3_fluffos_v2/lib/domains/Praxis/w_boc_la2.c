...
void create() {
    ...
    set_day_long( "Western Praxis is a more rural district of town. "
    ...
    set_night_long("Street lamps line the streets of rural West "
	...
	(["road" : "Boc La Road runs east and west through Praxis.",
	  ...
	  "highway" : "A very heavily travelled highway to the "
	    "western lands of Rifts Earth. Beware of the Daroq Mountains.",
