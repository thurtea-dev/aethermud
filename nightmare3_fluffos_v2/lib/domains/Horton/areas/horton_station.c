...
void create() {
    ...
    set_long(
        ...
        "Horton lies to the north. The hovertrain to Chi-Town boards here.\n"
        "Type 'board train' to board (50 credits).");
    set_exits( ([
        "north" : "/domains/Horton/areas/horton_main_street",
        "east"  : "/domains/Horton/areas/horton_rail_spur"
    ]) );
    set_listen("default",
