// /daemon/occ.c
// AetherMUD  -  Occupational Character Class daemon
...
mapping query_occ(string occ_name) {
    ...
    case "cyber-knight":
        return ([
            ...
            "occ_skill_picks": 5,
            "secondary_skills": 5,
            /* Palladium book floors (was PS/PE/ME 12 - human <5% with 5 rolls).
             * Changed 2026-07-10 so humans can qualify without Titan dice. */
            "attribute_requirements": ([ "PS": 10, "PE": 10, "MA": 10, "ME": 10 ]),
            "starting_equipment":
